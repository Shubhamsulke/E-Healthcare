...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='badge badge-pill badge-warning' style="text-decoration:none;padding:5px; color:white; background-color:#8E44AD ;">Edit Details</span>			    	</a>
				</div>
				</a><br/>
				...
				<form action="addPatient.html" method="post" name="demo"><br/>
					<div class="form-group">
				     ...
				     <div class="form-group">
				      ...
				      required="required" max="2020-12-31">
				    </div>
				    ...
				    <div class="form-group">
				      <label>Covid Test already done?</label>
				      <input type="text" class="form-control" id="exampleInputEmail1" name="medicineAllergy"  value="Yes/No"
				      autocomplete="off" maxlength="50">
				    </div>
