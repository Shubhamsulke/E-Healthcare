...
<script>
	...
	<div class="container"><br/>
		...
		<div class="row">
			<div class="col-sm-5">
			<h1><span style="color:grey;">E</span><span style="color:red;">-</span><span style="color:grey;"></span> HEALTHCARE</h1>
			</div>
			<div class="col-sm-7">
			<p><b>Dr. Sanjay Singhania</b><br/> MBBS, DNB(Gen. Surgeon), MS, MNAMS, FMAS, FIAGES, FALS, AFIH</p>
			</div>
		</div>
		<hr/>
	<div class="demo">
			...
			<div>
				...
				<hr/>
				Our Centers:<br/>
			    1. Nashik, Maharashtra 422002 |
			    2. Thatte Nagar, Pune, Maharashtra 422005<br/>
			    Mobile No. 9762785987 | Phone No. 0253-2575151 | E-mail: sulkeshubham07@gmail.com	
			</div>	
