	    ...
	    <div class="col-sm-*">
			...
			<div class="sidenav">
				...
				<div style="background-color: #D0D3D4;">&nbsp;&nbsp;&nbsp;
					<span class="badge-pill badge-warning">&nbsp;&nbsp;<%= l.getRole().toUpperCase() %>&nbsp;&nbsp;</span><br/><br/>
					<b>Username:</b> <%= l.getUsername() %><br/><br/>
					<b>Id:</b> <%= l.getId() %><br/><br />
					<a href="editView.html">
			    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='badge badge-pill badge-warning' style="text-decoration:none;padding:5px; color:white; background-color:#8E44AD ;">Edit Details</span>
			    	</a>
				</div>
				</a><br/>
			  ...
			  <div class="card-body">
			    <p class="card-text">
			    	<form action="searchPatientById.html" method="post" >
						 <div class="form-group">
						 	<label>Id</label>
						 	<input type="text" class="form-control" id="exampleInputEmail1" name="id" placeholder="Enter id here"
			    ...
			    <p class="card-text">
			    	<form action="searchPatientByMobileNo.html" method="post" >
						 <div class="form-group">
						 	...
						 	<input type="text" class="form-control" id="exampleInputEmail1" name="mobileNo" placeholder="enter 10 digit mobile no here"
			    ...
			    <p class="card-text">
			    	<form action="searchPatientByAdharNo.html" method="post" >
						 <div class="form-group">
						 	...
						 	<input type="text" class="form-control" id="exampleInputEmail1" name="aadharNo" placeholder="enter adhar number here"
